...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      mega: envOrArray(process.env.DISCORD_NOTIFY_GROUP_MEGA),
      fatpack: envOrArray(process.env.DISCORD_NOTIFY_GROUP_FATPACK),
      blaster: envOrArray(process.env.DISCORD_NOTIFY_GROUP_BLASTER),
      hanger: envOrArray(process.env.DISCORD_NOTIFY_GROUP_HANGER),
      tin: envOrArray(process.env.DISCORD_NOTIFY_GROUP_TIN),
      etb: envOrArray(process.env.DISCORD_NOTIFY_GROUP_ETB),
    },
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      mega: envOrNumber(process.env.MAX_PRICE_SERIES_MEGA),
      fatpack: envOrNumber(process.env.MAX_PRICE_SERIES_FATPACK),
      blaster: envOrNumber(process.env.MAX_PRICE_SERIES_BLASTER),
      hanger: envOrNumber(process.env.MAX_PRICE_SERIES_HANGER),
      tin: envOrNumber(process.env.MAX_PRICE_SERIES_TIN),
      etb: envOrNumber(process.env.MAX_PRICE_SERIES_ETB),
    },
  },
